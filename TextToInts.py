...
# The purpose of this file is to convert the tweet_text given in the formatted tweet table with columns id, tweet_text and convert it into an array of integers representing the sequence of tokens
...
parser.add_argument('-iic', '--input_id_column', action='store', dest='in_id_column',
                    default=Database.tweets['id_column'], help='The name of the input column holding the tweet ids.')
...
parser.add_argument('-oic', '--output_id_column', action='store', dest='out_id_column',
                    default=Database.formatted_tweets['id_column'],
