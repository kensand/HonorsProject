...
parser.add_argument('-iic', '--input_id_column', action='store', dest='in_id_column',
                    default=Database.int_tweets['id_column'], help='The name of the input column holding the tweet ids.')
parser.add_argument('-itc', '--input_int_array_column', action='store', dest='in_int_array_column',
                    default=Database.int_tweets['int_array_column'], help='The name of the input column holding the tweet tokens.')
...
batch_size = embedding_size = size
